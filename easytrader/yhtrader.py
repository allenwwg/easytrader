...
class YHTrader(WebTrader):
    ...
    def login(self, throw=False):
        ...
        for account in accounts:
            if account['交易市场'] == '深A' and account['股东代码'].startswith('0') and account['股东代码'].endswith('(主)'):
                self.exchange_stock_account['0'] = account['股东代码'][0:10]
            elif account['交易市场'] == '沪A' and account['股东代码'].startswith('A') and account['股东代码'].endswith('(主)'):
